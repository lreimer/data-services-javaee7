...
@MessageDriven(activationConfig = {
        ...
        @ActivationConfigProperty(propertyName = "topicFilter", propertyValue = "de/qaware/oss/cloud/rabbit"),
        @ActivationConfigProperty(propertyName = "qos", propertyValue = "1")
})
@TransactionAttribute(value = TransactionAttributeType.REQUIRED)
public class RabbitMqSourceMDB implements MQTTListener {

    private static final Logger LOGGER = Logger.getLogger(RabbitMqSourceMDB.class.getName());
