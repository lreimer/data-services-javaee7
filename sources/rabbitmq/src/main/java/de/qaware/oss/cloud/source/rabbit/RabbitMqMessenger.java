...
@ConnectionFactoryDefinition(name = "java:app/rabbitmq/factory",
...
public class RabbitMqMessenger {
    ...
    @Resource(lookup = "java:app/rabbitmq/factory")
    ...
    public void publish(byte[] payload) {
        try (MQTTConnection conn = factory.getConnection()) {
            conn.publish("de/qaware/oss/cloud/rabbit", payload, 1, false);
        } catch (Exception e) {
